...
async function seed() {
  ...
  const posts = [
    {
      ...
      image: "/assets/img/blog/blog-driveway.webp",
    }, {
      ...
      image: "/assets/img/blog/blog-pressure-washing.webp"
    }, {
      ...
      blogBody: "Pressure washing is a great way to keep your home or business looking clean and fresh. It can also help prevent damage from mold, mildew, and other harmful substances. But how often should you pressure wash? And what are the benefits of doing so? In this blog post, we'll answer these questions and more!",
      tags: { connect: [{ id: blogTag.id },] },
      image: "/assets/img/blog/blog-dos-and-donts.webp"
    },{
      ...
      blogBody: "Pressure washing is a great way to keep your home or business looking clean and fresh. It can also help prevent damage from mold, mildew, and other harmful substances. But how often should you pressure wash? And what are the benefits of doing so? In this blog post, we'll answer these questions and more!",
      tags: { connect: [{ id: blogTag.id },] },
      image: "/assets/img/blog/blog-grease-trap.webp"
    } , {
      ...
      tags: { connect: [{ id: blogTag.id }, { id: fastReadTag.id }] },
      image: "/assets/img/blog/blog-choose-the-right.webp"
    }
  ]
  ...
  const services = [
    {
      title: "Driveways",
      image: "/assets/img/services/driveway.webp",
      type: { connect: { id: residentialType.id } },
      slug: "driveways",
      ...
      gallery: {
        create: [{
          image: "/assets/img/services/driveway/driveway-1.webp",
          altText: "First driveway that was cleaned by our company"
        }, {
          image: "/assets/img/services/driveway/driveway-2.webp",
          altText: "Second driveway that was cleaned by our company"
        }]
      }
    }, {
      title: "Homes",
      image: "/assets/img/services/homes.webp",
      slug: "homes",
      type: { connect: { id: residentialType.id } },
      ...
      gallery: {
        create: {
        image: "/assets/img/services/homes/homes-1.webp",
        altText: "First home that was cleaned by our company"
        }
      }
    }, {
      title: "Backyards",
      slug: "backyards",
      image: "/assets/img/services/backyard.webp",
      type: { connect: { id: residentialType.id } },
      ...
      gallery: {
        create: {
        image: "/assets/img/services/backyard/backyard-1.webp",
        altText: "First backyard that was cleaned by our company"
        }
      }
    },{
      title: "Front Porches",
      slug: "front-porches",
      image: "/assets/img/services/front-porch.webp",
      ...
      gallery: {
        create: {
        image: "/assets/img/services/front-porch/front-porch-1.webp",
        altText: "First front porch that was cleaned by our company"
        }
      }
    },{
      ...
      gallery: {
        create: {
        image: "/assets/img/services/curbside/curbside-1.webp",
        altText: "A curbside that was cleaned by our company"
        }
      }
    },{
      ...
      image: "/assets/img/services/outside-dining.webp",
      type: { connect: { id: commercialType.id } },
      ...
      gallery: {
        create: {
        image: "/assets/img/services/outside-dining/outside-dining-1.webp",
      ...
      image: "/assets/img/services/outside-cleaning.webp",
      ...
      gallery: {
        create: {
        image: "/assets/img/services/outside-cleaning/outside-cleaning-1.webp",
        altText: faker.lorem.words(),
        }
      }
    }
  ...
  const projects = [
    {
      ...
      slug: 'driveway-1',
      image: "/assets/img/projects/driveway-1.webp",
      service: { connect: {id: drivewayId} },
      projectBody: faker.lorem.words(100)
    }, {
      title: faker.lorem.words(),
      slug: 'home-1',
      image: "/assets/img/projects/home-1.webp",
      service: { connect: {id: homeId} },
      projectBody: faker.lorem.words(100)
    },{
      title: faker.lorem.words(),
      slug: 'home-2',
      image: "/assets/img/projects/home-2.webp",
      service: { connect: {id: homeId} },
      projectBody: faker.lorem.words(100)
    }, {
      title: faker.lorem.words(),
